<h2><a href="https://leetcode.com/problems/substring-with-largest-variance/">2360. Substring With Largest Variance</a></h2><h3>Hard</h3><hr><p>The <strong>variance</strong> of a string is defined as the largest difference between the number of occurrences of <strong>any</strong> <code>2</code> characters present in the string. Note the two characters may or may not be the same.</p>
